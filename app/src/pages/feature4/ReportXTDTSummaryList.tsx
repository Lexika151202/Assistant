...
// Functions: 18 (Xem+Lọc+Export+Import), 20 (Xem+Vòng đời), 21 (Phê duyệt/Từ chối)
...
export default function ReportXTDTSummaryList() {
  ...
  return (
    <Container>
      <Breadcrumb items={[
        ...
        { label: 'Biểu tổng hợp xúc tiến đầu tư' },
      ]} />
              ...
              {group.periodStatus !== 'Chưa tới hạn nộp báo cáo' && (
                <div className="flex items-center gap-2 ml-4">
                  <Button
                    size="sm"
                    variant="primary"
                    onClick={() => navigate('/feature-4/new')}
                  >
                    Lập báo cáo
                  </Button>
                  <button
                            ...
                            <tr key={file.id} className="border-t border-[#e5e7eb] hover:bg-[#f9fafb]">
                              ...
                              <td className="px-2 py-3">
                                <FileRowActions
                                  ...
                                  onEdit={() => navigate(`/feature-4/${file.id}/edit`)}
                                  onView={() => navigate(`/feature-4/${file.id}/view`)}
