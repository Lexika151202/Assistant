...
// Functions: 24 (Xem+Lọc+Export+Import), 26 (Xem+Vòng đời), 27 (Phê duyệt/Từ chối)
...
export default function ReportCommitmentList() {
              ...
              {group.periodStatus !== 'Chưa tới hạn nộp báo cáo' && (
                <div className="flex items-center gap-2 ml-4">
                  <Button
                    size="sm"
                    variant="primary"
                    onClick={() => navigate('/feature-5/new')}
                  >
                    Lập báo cáo
                  </Button>
                  <button
                            ...
                            <tr key={file.id} className="border-t border-[#e5e7eb] hover:bg-[#f9fafb]">
                              ...
                              <td className="px-2 py-3">
                                <FileRowActions
                                  ...
                                  onEdit={() => navigate(`/feature-5/${file.id}/edit`)}
                                  onView={() => navigate(`/feature-5/${file.id}/view`)}
